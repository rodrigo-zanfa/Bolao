...
{
    public class CreateModuloCommand : ICommand
    {
        public CreateModuloCommand(string descricaoGrid, double potencia, double correnteMaxima, double tensaoMaxima, double correnteCurtoCircuito, double tensaoCircuitoAberto, double coeficiente, int comprimento, int largura, int espessura)
        {
