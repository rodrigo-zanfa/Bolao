    ...
    public class UpdateProdutoCommandValidator : AbstractValidator<UpdateProdutoCommand>
    {
        public UpdateProdutoCommandValidator()
        {
            RuleFor(c => c.IdProduto)
                .GreaterThan(0).WithMessage(ValidatorMessageConstant.Produto.IdInvalido);
            ...
            When(c => c.ProdutoTipo.IdProdutoTipo == (int)ProdutoTipoEnum.Estrutura, () =>
            {
                ...
                RuleFor(c => c.Estrutura)
                    .SetValidator(new UpdateEstruturaCommandValidator());
            });
            ...
            When(c => c.ProdutoTipo.IdProdutoTipo == (int)ProdutoTipoEnum.Inversor, () =>
            {
                ...
                RuleFor(c => c.Inversor)
                    .SetValidator(new UpdateInversorCommandValidator());
            });
            ...
            When(c => c.ProdutoTipo.IdProdutoTipo == (int)ProdutoTipoEnum.Modulo, () =>
            {
                ...
                RuleFor(c => c.Modulo)
                    .SetValidator(new UpdateModuloCommandValidator());
            });
        }
    }
}
