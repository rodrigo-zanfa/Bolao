...
{
    public class AlterarProdutoQuantidadeCommandValidator : AbstractValidator<AlterarProdutoQuantidadeCommand>
    {
        public AlterarProdutoQuantidadeCommandValidator()
        {
            RuleFor(c => c.IdAux)
