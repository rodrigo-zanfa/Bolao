...
{
    public class UpdateClasseParceiroDistribuidorCommandValidator : AbstractValidator<UpdateClasseParceiroDistribuidorCommand>
    {
        public UpdateClasseParceiroDistribuidorCommandValidator()
        {
            RuleFor(c => c.IdClasseParceiroDistribuidor)
                .GreaterThan(0).WithMessage(ValidatorMessageConstant.ClasseParceiroDistribuidor.IdClasseParceiroDistribuidorInvalido);
